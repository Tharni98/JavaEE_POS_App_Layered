...
public class ItemDAOImpl implements ItemDAO{
    ...
    public boolean update(Connection connection, Item entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.executeUpdate(connection, "UPDATE Item SET itemName=?, itemQty=?, itemPrice=? WHERE itemCode=?", entity.getName(), entity.getQty(), entity.getPrice(), entity.getCode());
    }
