...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public boolean update(Connection connection, Customer entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.executeUpdate(connection, "UPDATE Customer SET cusName=?, cusAddress=?, cusSalary=? WHERE cusId=?", entity.getCustomerName(), entity.getAddress(), entity.getSalary(), entity.getCustomerId());
    }
